...
fn sum_big_numbers(x: u8, y: u8) -> felt {
    x + y
}

fn convert_to_felt(x: u8) -> felt252 {
    x.into() //TODO return x as a felt252.
}

fn convert_felt_to_u8(x: felt252) -> u8 {
    x.try_into().unwrap() //TODO return x as a u8.
}
...
fn test_sum_big_numbers() {
    ...
    assert(sum_big_numbers(255_u8, 255_u8) == 510_u32, 'Something went wrong');
}
